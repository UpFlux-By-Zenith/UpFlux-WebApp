...
public class PackageSignController : ControllerBase
{
    ...
    private readonly string _certPath = "/home/gursimar/RiderProjects/UpFlux-WebApp/upflux-webservice/Upflux-WebService/Cert/cert.pem"; // Path to custom cert
    private readonly string _keyPath = "/home/gursimar/RiderProjects/UpFlux-WebApp/upflux-webservice/Upflux-WebService/Cert/privatekey.pem"; // Path to private key
...
public async Task<IActionResult> SignFile(IFormFile file)
{
    ...
    try
    {
        ...
        {
            FileName = "gpg",
            Arguments = $"--batch --yes --armor --output \"{signedFilePath}\" --detach-sign --default-key \"49FA55F02ADF3C914E0ABBC4E5C81D52A866B46B\" \"{filePath}\"",
